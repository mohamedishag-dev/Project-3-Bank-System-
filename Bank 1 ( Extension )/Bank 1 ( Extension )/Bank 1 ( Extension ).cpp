...
void PrintTotalBalanceClientRecord(sClient& Client)
{
	cout << "| " << setw(15) << left << Client.AccountNumber;
	cout << "| " << setw(40) << left << Client.Name;
	cout << "| " << setw(12) << left << Client.AccountBalance;
...
enum enTransactionsOptions { Deposit = 1, Withdraw = 2, TotalBalances = 3, GoToMainMenue = 4 };
...
void ShowTotalBalances()
{
	...
	if (vClients.size() == 0)
	{
		...
		for (sClient C : vClients)
		{
			PrintTotalBalanceClientRecord(C);
...
short ReadGoTransactionsMenueOptions()
{
	short Chose;
...
void GoBackToTransactionsMenueOption()
{
	cout << "\n\nPress any key to back Transactions Menue...";
	system("pause>0");
	ShowTransactionsMenue();
}

void PerfromTransactionsMenueOption(enTransactionsOptions TransactionsOptions)
{
	...
	case enTransactionsOptions::Deposit:
	{
		system("cls");
		ShowDepositScreen();
		GoBackToTransactionsMenueOption();
		break;
	}
	...
	case enTransactionsOptions::GoToMainMenue:
	{
		ShowMainMenue();
	}
	}
...
void ShowTransactionsMenue()
{
	...
	cout << "\t[4] Main Menue.\n";
	cout << "========================================================\n";
	PerfromTransactionsMenueOption((enTransactionsOptions)ReadGoTransactionsMenueOptions());
}
